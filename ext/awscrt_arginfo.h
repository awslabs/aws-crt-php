...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_aws_crt_log_to_stdout, 0, 0, IS_VOID, 0)
ZEND_END_ARG_INFO()

#define arginfo_aws_crt_log_to_stderr arginfo_aws_crt_log_to_stdout

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_aws_crt_log_to_file, 0, 1, IS_VOID, 0)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_aws_crt_log_message, 0, 1, IS_VOID, 0)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_aws_crt_signing_config_aws_set_should_sign_header_fn, 0, 2, IS_VOID, 0)
	ZEND_ARG_TYPE_INFO(0, config, IS_LONG, 0)
	ZEND_ARG_TYPE_INFO(0, should_sign_header, IS_OBJECT, 0)
ZEND_END_ARG_INFO()
